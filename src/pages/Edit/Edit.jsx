...
const Edit = () => {
  ...
  const handleEdit = async () => {
    if (img?.name) {
      const fileData = await storage.ref(`corso/${img.name}`).put(img);
          ...
          <div className="edit__right">
            <div className="edit__inputs">
              ...
              <div className="inputGroup">
                ...
                <input
                  type="number"
                  placeholder={capienzaMassima && capienzaMassima}
                  value={capienzaMassima && capienzaMassima}
                  onChange={(e) => setCapienzaMassima(e.target.value)}
                />
              </div>
              <div className="inputGroup">
